  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-300 to-purple-400">
      <div className=" bg-white/25 lg:w-[25%] w-[90%] p-[50px] rounded-lg shadow-2xl">
        <h1 className="mb-5 text-2xl text-white font-bold text-center">Sign Up</h1>
        <div>
        <div className="flex flex-col gap-4">
            ...
            <input 
              ...
              type="password"
            />
            <button className="mt-4 bg-purple-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-500 hover:text-white transition duration-300">Sign Up</button>
          </div>
        </div>
      </div>
    </div>
